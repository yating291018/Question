$(function(){
  ...
  function showitem(page){
   $.get("/page",{"page":page}).done(function(data){
        if(data){
   ...
   $(".items").on("click",".com_close",function(){
       var name=$(this).prev().find("a").text();
       var $this=$(this);
       if(name==username){
          $this.parents(".am-comment").fadeOut(500);
          $this.parents(".am-comment").next().fadeOut(500);
       }
   });
   ...
   $(".items").on("click",".reply",function(){
        var index=$(this).parents(".saitem").index();
        $.cookie("index",index);
        location.href="question.html";
   });
   $(".lookother").on("click",function(){
       location.href="lookother.html";
   });
});
function randColor(){
